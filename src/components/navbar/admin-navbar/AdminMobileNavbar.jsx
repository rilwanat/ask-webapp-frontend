...
import AskFooter from '../guest-navbar/GuestFooter';
...
import { navData } from '../guest-navbar/GuestNavData';
    ...
    <MenuContent className=''>
      <div className=''>
        ...
        <motion.span
          ...
          className="text-sm  text-theme cursor-pointer block my-4 mx-8  px-2 py-2 rounded-md hover:bg-theme hover:text-white"
          style={{ fontWeight: '600' }}
          onClick={() => {navigateTo('/admin-nominations');}}
        >
          Nominations
        </motion.span>
        ...
        <motion.span
          ...
          className="text-sm  text-theme cursor-pointer block my-4 mx-8  px-2 py-2 rounded-md hover:bg-theme hover:text-white"
          style={{ fontWeight: '600' }}
          onClick={() => {navigateTo('/sponsors-list');}}
        >
          Sponsors
        </motion.span>
        ...
        <motion.span
          ...
          className="text-sm  text-theme cursor-pointer block my-4 mx-8  px-2 py-2 rounded-md hover:bg-theme hover:text-white"
          style={{ fontWeight: '600' }}
          onClick={() => {navigateTo('/donations-list');}}
        >
          Manage Donations
        </motion.span>
        ...
        <motion.span
          ...
          className="text-sm  text-theme cursor-pointer block my-4 mx-8  px-2 py-2 rounded-md hover:bg-theme hover:text-white"
          style={{ fontWeight: '600' }}
          onClick={() => {navigateTo('/crypto-list');}}
        >
          Manage Crypto
        </motion.span>
