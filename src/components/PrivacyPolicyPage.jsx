...
<div className='flex flex-col sm:flex-row'>
    <div className=''>
        ...
        <ul className='ml-8 list-disc'>
            ...
            <li className='mb-2'><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ASK Foundation.</li>
            ...
            <li className='mb-2'><strong>Country</strong> refers to: Nigeria</li>
            ...
            <li className='mb-2'><strong>Website</strong> refers to A.S.K Foundation, accessible from askfoundations.org</li>
        ...
        <ul className='ml-8 list-disc'>
            <li className='mb-2'>
                ...
                <ul className='ml-8 list-disc'>
                    ...
                    <li className='mb-2'><strong>Purpose:</strong> These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</li>
                </ul>
            </li>
            <li className='mb-2'>
                ...
                <ul className='ml-8 list-disc'>
                    ...
                    <li className='mb-2'><strong>Administered by:</strong> Us</li>
                    <li className='mb-2'><strong>Purpose:</strong> These Cookies identify if users have accepted the use of cookies on the Website.</li>
                </ul>
            </li>
            <li className='mb-2'>
                ...
                <ul className='ml-8 list-disc'>
                    <li className='mb-2'><strong>Type:</strong> Persistent Cookies</li>
                    <li className='mb-2'><strong>Administered by:</strong> Us</li>
                    <li className='mb-2'><strong>Purpose:</strong> These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</li>
                </ul>
            </li>
        </ul>
