...
export default function AdminSpecificAdmin({ 
  isMobile,
...
useEffect(() => { 
  ...
  const { selectedAdmin } = location.state || {};
    // alert(JSON.stringify(selectedAdmin), null, 2);
    ...
    const [adminData, setAdminData] = useState({
        ...
        userAccountName: selectedAdmin.account_name,
        userBankname: selectedAdmin.bank_name,
        userGender: selectedAdmin.gender,
        userStateOfResidence: selectedAdmin.state_of_residence,
        userProfilePicture: selectedAdmin.profile_picture,
        userEmailVerified: selectedAdmin.email_verified,
        userRegistrationDate: selectedAdmin.registration_date,
        userUserType: selectedAdmin.user_type,
        userEligibility: selectedAdmin.eligibility,
        userIsCheat: selectedAdmin.is_cheat,
        userOpenedWelcomeMsg: selectedAdmin.opened_welcome_msg,
  ...
  const [loading, setLoading] = useState(true);
    ...
    //notification modal
      ...
      const currentPageName = "Edit Admin";//adminData.userFullname;
        ...
        + "../../../" + selectedAdmin.profile_picture}
                                    ...
                                    <div className="flex flex-wrap ">
                                      <div className="w-full md:w-1/3 px-2 mb-4">
                                        ...
                                        {/* <div className="w-full md:w-1/3 px-2 mb-4">
                                            ...
                                            value={selectedAdmin.email_verified} 
                                            // onChange={(e) => setProductData({ ...productData, productItemName: e.target.value })}
                                            />
                                        </div> */}
                                    ...
                                    {/* <div className="flex flex-wrap ">
                                        <div className="w-full md:w-1/2 px-2 mb-4">
                                            ...
                                            value={selectedAdmin.registration_date} 
                                            // onChange={(e) => setProductData({ ...productData, productItemName: e.target.value })}
                                            />
                                        </div>
                                    ...
                                    {/* <div className="flex flex-wrap ">
                                        ...
                                        <div className="w-full md:w-1/3 px-2 mb-4">
                                            ...
                                            value={selectedAdmin.account_name}
                                            // onChange={(e) => setProductData({ ...productData, productSlug: e.target.value })}
                                            />
                                        </div>
                                        ...
                                        <div className="w-full md:w-1/3 px-2 mb-4">
                                            ...
                                            value={selectedAdmin.account_number}
                                            // onChange={(e) => setProductData({ ...productData, productSlug: e.target.value })}
                                            />
                                        </div>
                                    </div> */}
                                    ...
                                    <div className="flex flex-wrap ">
                                        {/* <div className="w-full md:w-1/2 px-2 mb-4">
                                            ...
                                            value={selectedAdmin.state_of_residence} 
                                            // onChange={(e) => setProductData({ ...productData, productItemName: e.target.value })}
                                            />
                                        </div> */}
                ...
                className="bg-gray-50 border border-gray-300 text-black text-sm focus:ring-gray-500 focus:border-gray-500 rounded-lg 
                    block w-full p-2.5"
                    value={adminData.userKycStatus}
                    onChange={(e) => {
                      // alert(e.target.value);
                      setAdminData({ ...adminData, userKycStatus: e.target.value })                      
                  }}
            >
                ...
                <option value="REJECTED">REJECTED</option>
                                    ...
                                    {/* <div className="flex flex-wrap ">
                                        ...
                                        <div className="w-full md:w-1/3 px-2 mb-4">
                                            ...
                                            value={selectedAdmin.opened_welcome_msg}
                                            // onChange={(e) => setProductData({ ...productData, productSlug: e.target.value })}
                                            />
                                        </div>
                                        ...
                                        <div className="w-full md:w-1/3 px-2 mb-4">
                                            ...
                                            value={selectedAdmin.vote_weight}
                                            // onChange={(e) => setProductData({ ...productData, productSlug: e.target.value })}
                                            />
                                        </div>
                                    </div> */}
