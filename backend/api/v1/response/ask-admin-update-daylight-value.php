...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (
        ...
        $updateDaylightSavings = $response->updateDaylightSavings(            
            $data->value
        );


        if ($updateDaylightSavings) {


            http_response_code(200);
            echo json_encode(array("status" => true, "message" => "Daylight Value Updated Successfully!"));
        } else {
