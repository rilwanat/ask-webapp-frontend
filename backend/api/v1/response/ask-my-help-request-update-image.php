    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $uniqueTargetFilePath)) {
            ...
            // && $helpToken
                ...
                $createResult = $response->UpdateHelpRequestImage($email, $uniqueTargetFilePath);
                ...
                if ($createResult) {
                    ...
                    echo json_encode([
                        "status" => false,
                        "message" => "Unable to update your Help Request image."
                    ]);
                }
            ...
            http_response_code(500);
            echo json_encode(["status" => false, "message" => "Image update failed."]);
        }
    } else {
        http_response_code(400);
